...
public interface IDBQueryService
{
    ...
    IQueryable<T> GetQuery<T>(Expression<Func<T, bool>> where, params Expression<Func<T, object>>[] includes) where T : class;
    IQueryable<T> GetQuery<T>(Expression<Func<T, bool>> where, params string[] includes) where T : class;
...
public class DBQueryService : IDBQueryService
{
    ...
    public IQueryable<T> GetQuery<T>(Expression<Func<T, bool>> where, params Expression<Func<T, object>>[] includes) where T : class
    {
        var query = _db.Set<T>().AsNoTracking();
        foreach (var include in includes)
            query = query.Include(include);
    ...
    public IQueryable<T> GetQuery<T>(Expression<Func<T, bool>> where, params string[] includes) where T : class
    {
        var query = _db.Set<T>().AsNoTracking();
        foreach (var include in includes)
            query = query.Include(include);
